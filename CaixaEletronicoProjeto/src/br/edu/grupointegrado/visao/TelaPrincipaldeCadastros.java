 ...
 * @author Luan
 */
public class TelaPrincipaldeCadastros extends javax.swing.JFrame {

    /**
     * Creates new form TelaPrincipal
     */
    public TelaPrincipaldeCadastros() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jMICadastroAgencia = new javax.swing.JMenuItem();
        jMRelatorio = new javax.swing.JMenu();
        jMIRelatorioCliente = new javax.swing.JMenuItem();
        jMIRelatorioAgencia = new javax.swing.JMenuItem();
        ...
        jMICadastroAgencia.setText("Agência");
        jMCadastro.add(jMICadastroAgencia);

        jMenuBar1.add(jMCadastro);

        jMRelatorio.setText("Relatório");

        jMIRelatorioCliente.setText("Cliente");
        jMRelatorio.add(jMIRelatorioCliente);

        jMIRelatorioAgencia.setText("Agência");
        jMRelatorio.add(jMIRelatorioAgencia);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPrincipaldeCadastros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaPrincipaldeCadastros().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JMenuItem jMICadastroAgencia;
    private javax.swing.JMenuItem jMICadastroCliente;
    private javax.swing.JMenuItem jMIRelatorioAgencia;
